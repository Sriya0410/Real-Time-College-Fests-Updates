...
export default function AdminFoodReceipt() {
  const { id } = useParams();
  ...
  useEffect(() => {
    (async () => {
      try {
        const res = await api.get(`/admin/orders/${id}/receipt`);
  ...
  if (err) {
    return (
      <div className="page">
        <div className="foodMsg error">{err}</div>
      </div>
    );
  }
    ...
    <div className="page">
      <div className="receiptWrap">
        <div className="receiptPaper" id="receipt">
          ...
          <div className="center">ADMIN RECEIPT COPY</div>
          ...
          {o.email ? <div className="small">EMAIL: {o.email}</div> : null}
          ...
          {o.notes ? <div className="small">NOTES: {o.notes}</div> : null}

          <div className="line" />
          <div className="center small">ADMIN VIEW</div>
        ...
        <div className="receiptActions">
          ...
          <Link className="btnSmall2" to="/admin/orders">
            Back
          </Link>
        </div>
      </div>
